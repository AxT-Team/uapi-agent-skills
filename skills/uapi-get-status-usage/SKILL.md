---
name: uapi-get-status-usage
description: "使用 UAPI 的“获取API端点使用统计”单接口 skill，处理 获取API端点使用统计、使用统计 等请求。 Use when the user wants get status usage, status usage, usage, rate limit status, usage statistics, concurrency status, or when you need to call GET /status/usage directly."
---
