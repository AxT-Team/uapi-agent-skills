---
name: uapi-get-network-pingmyip
description: "使用 UAPI 的“Ping 我的 IP”单接口 skill，处理 Ping 我的 IP、Ping 等请求。 Use when the user wants get network pingmyip, network pingmyip, pingmyip, or when you need to call GET /network/pingmyip directly."
---
